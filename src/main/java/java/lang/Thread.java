...
class Thread implements Runnable {
    ...
    /*
        阻塞式设置  Interruptible (阻塞回调对象)
        会调用Interruptible的 interrupt
     */
   ...
   /**
    ...
    /*
        ...
        如果  线程 的 中断 信号 被设置，由jvm抛出 线程 中断异常
    ...
    osthread->set_interrupted(false);  --> hotspot 源码，如果为 true，则 进行清除 ，设置为 false
    不清除中断信号
     */
