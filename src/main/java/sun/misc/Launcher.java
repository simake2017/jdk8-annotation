...
public class Launcher {
    ...
    private static String bootClassPath =
        System.getProperty("sun.boot.class.path"); //配置系统类加载器 加载 路径
    ...
    public Launcher() {
        ...
        try {
            loader = AppClassLoader.getAppClassLoader(extcl);  //这里的loader 是 AppClassLader
        } catch (IOException e) {
            throw new InternalError(
    ...
    static class ExtClassLoader extends URLClassLoader {
         ...
         */
        /*
            这里的classloader 为 null，所以父类的classloader为 null
    ...
    static class AppClassLoader extends URLClassLoader {
            ...
            throws IOException
        {
            /*
                wangyang
                找到这个 class.path 然后进行 分隔
                然后用这个分隔 作为 url，作为urlclassLoader的 urls 参数

             */
            final String s = System.getProperty("java.class.path"); // app classloader  用于 加载 java.class.path
    ...
    /*
        ...
        返回  对应的协议 处理工厂 ，比如  jar ，file  http等
     */
