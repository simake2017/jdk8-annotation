...
class PollArrayWrapper extends AbstractPollArrayWrapper {
    ...
    void initInterrupt(int fd0, int fd1) {
        interruptFD = fd1; //这里是 写
        putDescriptor(0, fd0);  //这里是fd0,表示读
        putEventOps(0, POLLIN); //in事件 ,感兴趣的事件是 read事件
        putReventOps(0, 0);
    }
